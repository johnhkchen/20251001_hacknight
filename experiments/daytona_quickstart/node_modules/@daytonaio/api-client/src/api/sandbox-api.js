...
const SandboxApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createSshAccess: async (sandboxId, xDaytonaOrganizationID, expiresInMinutes, options = {}) => {
            // verify required parameter 'sandboxId' is not null or undefined
            (0, common_1.assertParamExists)('createSshAccess', 'sandboxId', sandboxId);
            const localVarPath = `/sandbox/{sandboxId}/ssh-access`.replace(`{${'sandboxId'}}`, encodeURIComponent(String(sandboxId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        revokeSshAccess: async (sandboxId, xDaytonaOrganizationID, token, options = {}) => {
            // verify required parameter 'sandboxId' is not null or undefined
            (0, common_1.assertParamExists)('revokeSshAccess', 'sandboxId', sandboxId);
            const localVarPath = `/sandbox/{sandboxId}/ssh-access`.replace(`{${'sandboxId'}}`, encodeURIComponent(String(sandboxId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        setAutoDeleteInterval: async (sandboxId, interval, xDaytonaOrganizationID, options = {}) => {
            // verify required parameter 'sandboxId' is not null or undefined
            (0, common_1.assertParamExists)('setAutoDeleteInterval', 'sandboxId', sandboxId);
            // verify required parameter 'interval' is not null or undefined
...
const SandboxApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createSshAccess(sandboxId, xDaytonaOrganizationID, expiresInMinutes, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createSshAccess(sandboxId, xDaytonaOrganizationID, expiresInMinutes, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async revokeSshAccess(sandboxId, xDaytonaOrganizationID, token, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.revokeSshAccess(sandboxId, xDaytonaOrganizationID, token, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async setAutoDeleteInterval(sandboxId, interval, xDaytonaOrganizationID, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.setAutoDeleteInterval(sandboxId, interval, xDaytonaOrganizationID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
