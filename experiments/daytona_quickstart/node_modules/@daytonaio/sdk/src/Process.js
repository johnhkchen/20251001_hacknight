...
class Process {
    ...
    toolboxApi;
    getPreviewLink;
    constructor(sandboxId, clientConfig, codeToolbox, toolboxApi, getPreviewLink) {
...
function demuxLog(data) {
    ...
    while (remaining.length > 0) {
        ...
        const stdoutIndex = findSubarray(remaining, exports.STDOUT_PREFIX_BYTES);
        const stderrIndex = findSubarray(remaining, exports.STDERR_PREFIX_BYTES);
